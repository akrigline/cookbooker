...
Establishes the local Dexie/IndexedDB database for the DIY Cookbook Creator, sets up relational tables for recipes, projects, chapters, and recipe-to-project mappings, supports seed data on first launch, and provides backup/restore utilities to prevent data loss from browser cache clears.
