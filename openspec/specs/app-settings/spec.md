...
Stores a single set of app-wide preferences in IndexedDB, independent of any recipe or project,
covering the settings that apply uniformly across the whole app (starting with ingredient
quantity alignment) rather than being duplicated per recipe or per cookbook.
