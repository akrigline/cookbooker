...
<template>
  <div class="ri-body" :class="{ 'ri-body--with-sidebar': isInputStage }">
    ...
    <template v-if="isReviewStage">
      ...
      <div style="display:flex; justify-content:flex-end; gap:10px; padding-top:8px; border-top:1px solid var(--gray-88); flex-wrap:wrap;">
...
.btn-secondary:hover { background:var(--gray-93); }
