...
- Title: columns 1-12 of 12 (~left 0.00in, top 0.00in, width 7.50in, height 0.63in)
- Ingredients: columns 1-4 of 12 (~left 0.00in, top 1.00in, width 2.38in, height 7.63in), 1 column, qty alignment: right
- Image: columns 5-12 of 12 (~left 2.57in, top 1.00in, width 4.88in, height 2.20in)
- Chef's Notes: columns 5-12 of 12 (~left 2.58in, top 3.29in, width 4.88in, height 1.50in), boxed background (surface-container-low + outline-variant border)
- QR Code: columns 2-3 of 12 (~left 0.49in, top 4.79in, width 1.25in, height 1.25in), caption visible, size fixed at 1.25in x 1.25in (do not resize - RecipeQRCode.vue stamps its SVG at this exact size)
- Instructions: columns 5-12 of 12 (~left 2.57in, top 4.84in, width 4.88in, height 5.13in)
