...
- Image: columns 1-4 of 12 (~left 0.00in, top 0.61in, width 2.38in, height 2.45in)
- Instructions: columns 5-12 of 12 (~left 2.55in, top 0.61in, width 4.95in, height 8.88in)
- Chef's Notes: columns 1-4 of 12 (~left 0.00in, top 3.23in, width 2.38in, height 1.63in), boxed background (surface-container-low + outline-variant border)
- Ingredients: columns 1-4 of 12 (~left 0.00in, top 5.04in, width 2.38in, height 3.25in), 1 column, qty alignment: right
- QR Code: columns 2-3 of 12 (~left 0.49in, top 8.75in, width 1.25in, height 1.25in), caption visible, size fixed at 1.25in x 1.25in (do not resize - RecipeQRCode.vue stamps its SVG at this exact size)
