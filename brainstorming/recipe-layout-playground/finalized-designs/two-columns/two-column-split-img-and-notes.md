...
- Image: columns 1-4 of 12 (~left 0.00in, top 1.00in, width 2.38in, height 2.45in)
- Chef's Notes: columns 5-12 of 12 (~left 2.63in, top 1.00in, width 4.88in, height 1.25in), boxed background (surface-container-low + outline-variant border)
- Instructions: columns 5-12 of 12 (~left 2.60in, top 2.41in, width 4.88in, height 7.55in)
- Ingredients: columns 1-4 of 12 (~left 0.00in, top 3.45in, width 2.38in, height 5.38in), 1 column, qty alignment: right
